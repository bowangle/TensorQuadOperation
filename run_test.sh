...
rm -f test/test_Mat_QR.txt test/test_Mat_SVDDecomp.txt test/test_Tensor3D.txt test/test_TT_base.txt test/test_MPS_base.txt test/test_compress_svd.txt test/test_mpo.txt
...
./build/Test_MPO         > test/test_mpo.txt       2>&1 &
